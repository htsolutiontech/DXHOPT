...
function ThongKeThang_Export({ data, filteredData, onClose, visible }) {
  ...
  const exportOptions = {
    ...
    fileName: `thong_ke_xuat_kho_theo_thang${new Date().toISOString().split('T')[0]}`,
    includeHeaderRow: true
  };

  return (
    <Modal
      title={<div className="export-modal-title"><FileExcelOutlined /> Xuất thống kê xuất kho theo tháng</div>}
      open={visible}
      onCancel={onClose}
      width={700}
      footer={[
