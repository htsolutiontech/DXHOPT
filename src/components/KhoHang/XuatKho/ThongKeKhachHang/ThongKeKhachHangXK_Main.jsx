...
import ThongKeKhachHangXK_Export from './ThongKeKhachHangXK_Export';
import ThongKeKhachHangXK_Filter from './ThongKeKhachHangXK_Filter';
import { filterThongKeKhachHang } from './ThongKeKhachHangXK_FilterLogic';
import '../../../utils/css/Highlight.css';
import '../../../utils/css/Custom-Button.css';
import '../../../utils/css/Custom-Filter.css';
import './ThongKeKhachHangXK_Main.css';

const ThongKeKhachHangXK = () => {
  ...
  filteredRawData.forEach(item => {
    ...
    const soLuong = item.so_luong_xuat || 0;
  ...
  if (matchedCustomer) {
    columns = [
      ...
      },
      {
        ...
        width: 120,
        render: value => (
          <div className={value > 0 ? 'red-highlight' : ''}>
            {value > 0 ? value : 0}
          </div>
        ),
      },
  ...
  return (
    <div className="thong-ke-khach-hang-container">
      <AreaHeader
        title="Tổng số lượng hàng xuất theo khách hàng"
        onExportClick={() => setShowExportModal(true)}
        hideAddButton
      />
      <ThongKeKhachHangXK_Export
        data={tableData}
...
export default ThongKeKhachHangXK;