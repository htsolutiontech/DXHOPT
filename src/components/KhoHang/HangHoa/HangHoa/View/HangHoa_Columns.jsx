...
export const getHangHoaColumns = (handleEdit, handleRemove, canEdit) => [
    ...
    { title: 'Tên hàng', dataIndex: 'ten_hang', key: 'ten_hang', width: "13%", sorter: (a, b) => (a.ten_hang || '').localeCompare(b.ten_hang || '') },
    { 
        title: 'Loại hàng', 
    ...
    { title: 'Ngày giá', dataIndex: 'ngay_gia', key: 'ngay_gia', width: "5%", render: (text) => formatDate(text) },
    {
