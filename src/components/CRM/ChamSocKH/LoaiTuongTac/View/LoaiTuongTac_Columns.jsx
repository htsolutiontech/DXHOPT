...
export const getLoaiTuongTacColumns = (handleEdit, handleRemove, canEdit) => [
    { title: 'STT', dataIndex: 'stt', key: 'stt', width: "5%" },
    { title: 'Mã loại tương tác', dataIndex: 'ma_loai_tuong_tac', key: 'ma_loai_tuong_tac', width: "10%", sorter: (a, b) => (a.ma_loai_tuong_tac || '').localeCompare(b.ma_loai_tuong_tac || '') },
    { title: 'Loại tương tác', dataIndex: 'loai_tuong_tac', key: 'loai_tuong_tac', width: "20%", sorter: (a, b) => (a.loai_tuong_tac || '').localeCompare(b.loai_tuong_tac || '') },
