...
import { getLoaiBaoGiaColumns } from './LoaiBaoGia_Columns';
import '../LoaiBaoGia_Main.css';

const LoaiBaoGiaTableView = ({
    data,
    currentPage,
    pageSize,
    loading,
    ...
    // Lấy columns gốc
    let columns = getLoaiBaoGiaColumns(handleEdit, handleRemove, canEdit);
...
export default LoaiBaoGiaTableView;
