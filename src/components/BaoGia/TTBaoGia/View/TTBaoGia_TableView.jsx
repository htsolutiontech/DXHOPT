...
import { getTTBaoGiaColumns } from './TTBaoGia_Columns';
import '../TTBaoGia_Main.css';

const TTBaoGiaTableView = ({
    data,
    currentPage,
    pageSize,
    loading,
    ...
    // Lấy columns gốc
    let columns = getTTBaoGiaColumns(handleEdit, handleRemove, canEdit);
...
export default TTBaoGiaTableView;
